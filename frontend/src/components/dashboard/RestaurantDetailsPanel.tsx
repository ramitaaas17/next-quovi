          ...
          >
            ...
            <div className="p-6 space-y-6">
              <div>
                ...
                <div className="flex items-center space-x-4">
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="text-gray-500 text-sm">({restaurant.reviews} reseñas)</span>
                  </div>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                onClick={onShowRoute}
                className="w-full bg-gradient-to-r from-orange-500 to-red-500 text-white py-4 rounded-2xl font-bold text-lg flex items-center justify-center space-x-3 shadow-lg hover:shadow-xl transition-shadow"
              >
                ...
                {restaurant.phone && (
                  <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-xl">
                    ...
                    <div>
                      ...
                      <a href={`tel:${restaurant.phone}`} className="text-gray-800 hover:text-orange-500">
                        {restaurant.phone}
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-xl">
                    ...
                    <div>
                      ...
                      <a 
                        ...
                        className="text-gray-800 hover:text-orange-500 truncate"
                      >
                        Visitar sitio web
                      </a>
                    </div>
